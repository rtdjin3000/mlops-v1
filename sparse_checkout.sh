...
git_folder_location='C:\Users\rittw\Documents\PythonScripts\mlopsv2root'   #replace with the local root folder location where you want to create the project folder
project_name=mlopsv1-sparse   #replace with your project name
github_org_name=rtdjin3000   #replace with your github org name
project_template_github_url=https://github.com/rtdjin3000/mlops-v1  #replace with the url for the project template for your organization created in step 2.2, or leave for demo purposes
